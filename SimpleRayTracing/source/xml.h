/* Copyright (C)  Michael Chourdakis
Code Project Open License (CPOL) - http://www.codeproject.com/info/cpol10.aspx

XML LIBRARY LICENSE AGREEMENT
=============================


You are free to use my code for any project, freeware or shareware, public domain or commercial, as long as you:

 a) Credit me in your application's documentation and/or the about box
 b) Register at my forum (http://www.turboirc.com/forum) so you receive updates and news about the library.
 c) Drop me a note via the forum for the name of the application so I can link to you.
...
#define XML_VERSION 0x141
#define XML_VERSION_REVISION_DATE "23-07-2008"
...
//      static void Kill(char* tf);
	  ...
	  int LoadText(const char*);
	  int LoadText(const wchar_t*);
...
//		void SetElementParam(unsigned __int64 p);
		void SetElementParam(unsigned int p);
//		unsigned __int64 GetElementParam();
		unsigned int GetElementParam();
