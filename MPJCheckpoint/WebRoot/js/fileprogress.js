...
function FileProgress(file,fileListID,swfUploadInstance) {
	if(!document.getElementById(file.id)){
		...
		td = tr.insertCell(-1);td.className='uploadTD';
		td.innerHTML="Wait For Upload<span id="+file.id+"_bar class=uploadBar></span>";
		td = tr.insertCell(-1);td.className='uploadTD';
		td.innerHTML="<span id="+file.id+"_del class=uploadCancel>Cancel</span>";
