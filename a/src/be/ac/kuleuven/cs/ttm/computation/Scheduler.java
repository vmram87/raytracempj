 ...
 *
 * @version $Id: Scheduler.java,v 1.4 2000/11/06 14:47:35 cvs Exp $
 * @author  <A HREF="http://www.cs.kuleuven.ac.be/~tim">Tim Coninx</A>
 */
public class Scheduler extends be.ac.kuleuven.cs.ttm.ttm.Scheduler {
   ...
   */
  public be.ac.kuleuven.cs.ttm.ttm.Computation currentComputation() {
	return (be.ac.kuleuven.cs.ttm.ttm.Computation)ThreadMapping.getInstance().getComputation();
  }  
